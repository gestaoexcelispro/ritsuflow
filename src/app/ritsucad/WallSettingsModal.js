  ...
  return (
    <div className="ritsucadWallModalBackdrop" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && onCancel?.()}>
      ...
      <style jsx global>{`
        ...
        .ritsucadWallModalGrid{display:grid;grid-template-columns:1fr 1fr;gap:14px;padding:16px 22px}.ritsucadWallField{display:flex;flex-direction:column;gap:6px}.ritsucadWallField:nth-child(2){grid-column:span 2}.ritsucadWallField label{font-size:10px;font-weight:900;letter-spacing:.04em;color:#31556b}
        ...
        @media(max-width:640px){.ritsucadWallModalGrid{grid-template-columns:1fr}.ritsucadWallField:nth-child(2){grid-column:auto}.ritsucadWallTypeBar{grid-template-columns:1fr}.ritsucadWallNewType{width:100%}}
      `}</style>
    </div>
  )
}
