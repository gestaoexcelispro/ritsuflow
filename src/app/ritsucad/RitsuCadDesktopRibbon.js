  ...
  return createPortal(<>
    ...
    <section className="rfDesktopRibbon" data-ritsucad-desktop-ribbon="true">
      <nav className="rfRibbonTabs">
        ...
        <div className="rfRibbonBrand" aria-label="RitsuCAD by RitsuFlow"><strong>RitsuCAD™</strong><img src="/logo.png" alt="RitsuFlow" /></div>
      </nav>
...
.rfRibbonTabs{height:34px;flex:0 0 34px;display:flex;align-items:stretch;justify-content:space-between;padding:0 12px 0 18px;border-bottom:1px solid #c9d5dc;background:#fff;overflow:hidden}.rfRibbonTabList{display:flex;align-items:flex-end;gap:2px;min-width:0}.rfRibbonTabs button{height:34px;min-width:78px;padding:0 16px;border:0;border-bottom:3px solid transparent;background:transparent;color:#244b60;font:inherit;font-size:11px;font-weight:850;cursor:pointer}.rfRibbonTabs button:hover{background:#e9f1f4}.rfRibbonTabs button.active{color:#008f88;border-bottom-color:#00a59d;background:#f4fbfb}.rfRibbonBrand{height:34px;flex:0 0 auto;display:flex;align-items:center;gap:12px;padding-left:18px;background:#fff}.rfRibbonBrand strong{font-size:11px;color:#244b60;white-space:nowrap;letter-spacing:.02em}.rfRibbonBrand img{display:block;width:auto;height:27px;max-width:130px;object-fit:contain}
...
@media(max-width:1000px){.rfRibbonTabs{padding-left:8px}.rfRibbonTabs button{min-width:58px;padding:0 9px}.rfRibbonBrand strong{display:none}.rfRibbonBrand img{height:24px;max-width:100px}.rfCommandItems button{min-width:62px;padding:5px}.rfStatus span:nth-child(-n+2){display:none}}
`