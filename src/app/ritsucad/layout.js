...
import SavedLocationGeometryBridge from './SavedLocationGeometryBridge'
...
export default function RitsuCadLayout({ children }) {
  return <div style={{width:'100%',height:'100vh',minWidth:0,minHeight:0,margin:0,overflow:'hidden',background:'#dfe6ec'}}>
    <style>{`
      ...
      [data-ritsucad-approved-shell="true"] > [data-ritsucad-file-source="true"][class*="toolbarSection"],[data-ritsucad-approved-shell="true"] > [class*="toolbarSection"]:nth-of-type(3),[data-ritsucad-approved-shell="true"] > [class*="toolbarSection"]:nth-of-type(4),[data-ritsucad-approved-shell="true"] > [data-ritsucad-edit-setup-source="true"]{display:none!important}
