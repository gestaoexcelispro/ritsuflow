...
export default function RitsuCadLayout({ children }) {
  return <div style={{width:'100%',height:'100vh',minWidth:0,minHeight:0,margin:0,overflow:'hidden',background:'#dfe6ec'}}>
    <style>{`
      ...
      /* RitsuCAD approved sidebar housekeeping:
         FILE actions live in the header, so their original toolbar source
         must never render as a duplicate sidebar group. */
      [data-ritsucad-approved-shell="true"] > [data-ritsucad-file-source="true"] {
