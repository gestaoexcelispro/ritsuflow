...
export default function RitsuCadLayout({ children }) {
  return <div style={{width:'100%',height:'100vh',minWidth:0,minHeight:0,margin:0,overflow:'hidden',background:'#dfe6ec'}}>
    <style>{`
      ...
      /* FILE actions belong exclusively to the header.
         The source section stays mounted so the header bridge can proxy its
         actions, but it is forcibly excluded from the visible sidebar. */
      ...
      [data-ritsucad-approved-shell="true"] > [class*="toolbarSection"]:nth-of-type(3)::before {
        content: 'DRAW' !important;
      }
      [data-ritsucad-approved-shell="true"] > [class*="toolbarSection"]:nth-of-type(4)::before {
        content: 'MEASURE · TAKEOFF' !important;
      }
