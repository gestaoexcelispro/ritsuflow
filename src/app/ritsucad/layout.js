  ...
  return (
    <div className="ritsucad-shell">
      <style>{`
        ...
        /* Keep RitsuCAD intentionally denser than standard project pages. */
        ...
        [class*="applicationHeader"] {
          ...
          border-bottom: 1px solid #0d5369 !important;
          color: #fff !important;
        ...
        /* Panels stay closed until explicitly opened; when open they float over the CAD. */
        [class*="_inspector__"] {
          ...
          box-shadow: -5px 8px 24px rgba(15, 23, 42, .14) !important;
