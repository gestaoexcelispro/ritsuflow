...
export default function ProjectsPage(){
 ...
 return <main className={styles.shell}>
  <header className={styles.topbar}>
   ...
   <div className={styles.user}><button className={styles.alert}>♧<em>3</em></button><Link href="/projects/new" className={styles.newProject}>＋ New Project</Link><b>EF</b><div><strong>Eduardo Freitas</strong><span>Operations Manager</span></div><span>⌄</span></div>
  </header>
  ...
  <div className={styles.content}>
   ...
   <section className={styles.projectsPanel}>
    ...
    <div className={styles.tableWrap}>
     <table><thead><tr><th>Project ID</th><th>Project</th><th>Location</th><th>Project Manager</th><th>Phase</th><th>Workers</th><th>Operations</th><th>Today’s Progress</th><th>Open Issues</th><th>Status</th><th>Last Update</th><th></th></tr></thead>
      <tbody>
